 ...
 *   title="Payment",
 *   required={},
 *   @OA\Property(type="integer",description="id of Payment",title="id",property="id",example="1",readOnly="true"),
 *   @OA\Property(type="string",description="name of Payment",title="name",property="name",example="Macbook Pro"),
 *   @OA\Property(type="string",description="sku of Payment",title="sku",property="sku",example="MCBPRO2022"),
 *   @OA\Property(type="integer",description="price of Payment",title="price",property="price",example="99"),
 ...
 *     @OA\Items(type="object",ref="#/components/schemas/Payment"),
 *   ),
