 ...
 *   title="Founder",
 *   required={},
 *   @OA\Property(type="integer",description="id of Founder",title="id",property="id",example="1",readOnly="true"),
 *   @OA\Property(type="string",description="name of Founder",title="name",property="name",example="Macbook Pro"),
 *   @OA\Property(type="string",description="sku of Founder",title="sku",property="sku",example="MCBPRO2022"),
 *   @OA\Property(type="integer",description="price of Founder",title="price",property="price",example="99"),
 ...
 *     @OA\Items(type="object",ref="#/components/schemas/Founder"),
 *   ),
