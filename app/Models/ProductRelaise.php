 ...
 *   required={},
 *   @OA\Property(type="integer",description="id of ProductRelaise",title="id",property="id",example="1",readOnly="true"),
 *   @OA\Property(type="string",description="name of ProductRelaise",title="name",property="name",example="Macbook Pro"),
 *   @OA\Property(type="string",description="sku of ProductRelaise",title="sku",property="sku",example="MCBPRO2022"),
 *   @OA\Property(type="integer",description="price of ProductRelaise",title="price",property="price",example="99"),
 ...
 *
 * @OA\Schema (
 *   schema="ProductRelaises",
 *   title="ProductRelaises list",
 *   @OA\Property(title="data",property="data",type="array",
 *     @OA\Items(type="object",ref="#/components/schemas/ProductRelaise"),
 *   ),
