 ...
 *   @OA\Property(type="string",description="name of Role",title="name",property="name",example="Macbook Pro"),
 *   @OA\Property(type="string",description="sku of Role",title="sku",property="sku",example="MCBPRO2022"),
 *   @OA\Property(type="integer",description="price of Role",title="price",property="price",example="99"),
