 ...
 *   title="Brand",
 *   required={},
 *   @OA\Property(type="integer",description="id of Brand",title="id",property="id",example="1",readOnly="true"),
 *   @OA\Property(type="string",description="name of Brand",title="name",property="name",example="Macbook Pro"),
 *   @OA\Property(type="string",description="sku of Brand",title="sku",property="sku",example="MCBPRO2022"),
 *   @OA\Property(type="integer",description="price of Brand",title="price",property="price",example="99"),
 ...
 *     @OA\Items(type="object",ref="#/components/schemas/Brand"),
 *   ),
